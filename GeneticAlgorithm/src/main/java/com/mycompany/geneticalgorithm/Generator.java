...
public class Generator {
    ...
    private final double fitValue = 200000;
    ...
    public double generatePhenotype(Person p1, Person p2) {
        ...
        double rankValue;
        Random r = new Random();
        double male = r.nextInt((p1.getPersonID().length())) * 1.33;
        double female = r.nextInt((p2.getPersonID().length())) * 2.49;
        rankValue = (Math.log(1.5) * (p1.getRank() * female + p2.getRank() * male) * 0.79);
